...
os.environ["OPENAI_API_KEY"] = "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"

llm = ChatOpenAI(temperature=1.0, model='gpt-3.5-turbo-0613')

initial_message = "pretend to be a horrible scientist doctor that only give the  most chaotic idea for his patients"
